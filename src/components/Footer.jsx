...
const Footer = () => {
  return (
    <>
      <div className='w-full bg-red-600 text-white py-3 text-center'>HOMEGROWN INDIAN BRAND</div>
      <div className='w-full bg-white text-black text-center py-3'>Over <b>6 Million</b> Happy Customers</div>
